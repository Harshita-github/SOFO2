        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                ...
                <span class="navbar-toggler-bar bar3"></span>
                        ...
                        <a class="navbar-brand" href="tables1.html">Interface Analysis</a>
                    </div>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Interface Analysis</h4>
                            </div>
            ...
            <footer class="footer" style="padding-bottom: 024px;margin-top: 14px;">
                <div class="container-fluid">
                    <ul class="nav">
                    </ul>
                    <p>
